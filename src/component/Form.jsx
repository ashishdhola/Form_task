                    ...
                    <form action="" metdod='post' onSubmit={(e) => { submitdata(e) }}>
                        ...
                        <div className='borders'>
                            <div className='values'>
                                ...
                                <div style={{ display: "flex" }}>
                                    <input type="checkbox" name='hobbies' value={"Cricket"} checked={hob.includes('Cricket') ? "checked" : ""} onChange={(e) => { setinput(e)}} />Cricket
                                </div>
                                <div style={{ display: "flex" }}>
                                ...
                                <div style={{ display: "flex" }}>
                                    <input type="checkbox" name='hobbies' value={"Chess"} checked={hob.includes('Chess') ? "checked" : ""} onChange={(e) => { setinput(e) }} />Chess
                                </div>
                            </div>
                        </div>
                        {/* ============================================================password */}
